...
-- #########################################
-- cartesian category instances for Product in the category Transformation
-- #########################################
...
-- #########################################
-- cocartesian category instances for Sum in the category Transformation
-- #########################################
