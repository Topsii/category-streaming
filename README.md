...
| [ffunctor](https://hackage.haskell.org/package/ffunctor) <br> [hkd](https://github.com/ekmett/hkd)                                                                                                                                                     | prefix F                                                                    | NaturalTransformation                                                                                        | (->)                  |
...
| [witherable](https://hackage.haskell.org/package/witherable)                                                                                                                                                                                           | Functor ~ Filterable <br> Traversable ~ Witherable                          | a -> Maybe b                                                                                                 | (->)                  |
...
| [witherable](https://hackage.haskell.org/package/witherable)                                                                                                                                                                                           | Functor ~ Filterable <br> Traversable ~ Witherable <br> suffix WithIndex    | i -> a -> Maybe b                                                                                            | (->)                  |
...
- https://web.archive.org/web/20240805005050/https://eevie.ro/posts/2019-05-12-functor-of.html
